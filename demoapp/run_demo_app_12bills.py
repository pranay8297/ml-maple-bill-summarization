...
TWELVE_BILLS_WITH_MGL_FILE_PATH = "demoapp/12_bills_with_more_sections.pq"
...
def render_response():
    ...
    df = pd.read_parquet(TWELVE_BILLS_WITH_MGL_FILE_PATH)
    #get bill information based on the bill selected
    bill_number, bill_title, bill_text = get_selected_bill_info_12_bills(df)
